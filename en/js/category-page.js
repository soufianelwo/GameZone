...
(function () {
    ...
    const JS_FILES = [
        '/en/js/aa_action_games.js',
        '/en/js/aa_arcade_games.js',
        '/en/js/aa_battleroyale_games.js',
        '/en/js/aa_idle_games.js',
        '/en/js/aa_multiplayer_games.js',
        '/en/js/aa_puzzle_games.js',
        '/en/js/aa_sandbox_games.js',
        '/en/js/aa_sports_games.js',
        '/en/js/games.js',
    ];
    ...
    function buildNav() {
        ...
        const categories = [{ name: 'All games', value: '' }, ...cats.map(c => ({ name: c, value: c }))];

        headerNav.innerHTML = '';
        categories.forEach(cat => {
            const a = document.createElement('a');
            a.href = cat.value === '' ? '/en/' : '/en/' + cat.value.toLowerCase().replace(' ', '') + '/';
            ...
            pageGames.forEach(function (game, idx) {
                ...
                card.innerHTML =
                    '<div class="card-thumb">' +
                        ...
                        '<div class="card-overlay"><button class="play-btn">▶ Play</button></div>' +
                ...
                card.addEventListener('click', function () {
                    window.location.href = '/en/game/' + slugify(game.title);
                });
